...
4.7 No campo URL do Repositório, especifique o repositório clonado, por exemplo: [ttps://github.com/FabianoCarneiro/pipelines.git](https://github.com/Faculdade-Impacta-Devops/pipeline)
